...
def set_arguments(parser):
    ...
    parser.add_argument('--data_dir', action='store', type=str, default='./assets/Benchmarking_Camera_Calibration_2008/fountain-P11/images',
    ...
    parser.add_argument('--out_dir', action='store', type=str, default='./assets/Benchmarking_Camera_Calibration_2008/fountain-P11',
...
def feat_match(opts, data_files=[]):
    ...
    for i, img_path in enumerate(img_paths):
        ...
        if (i % opts.print_every) == 0:
            print(
                'FEATURES DONE: {0}/{1} [time={2:.2f}s]'.format(i+1, len(img_paths), t2-t1))
